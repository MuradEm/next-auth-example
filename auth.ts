  ...
  providers: [
    ...
    CredentialsProvider({
      ...
      async authorize(credentials, req) {
        ...
        const res = await fetch("https://tools.info-rmi.com/timesheetapi/ISAPI.dll/login", {
          method: 'POST',
    ...
    // GitHub({ clientId: process.env.GITHUB_ID as string, clientSecret: process.env.GITHUB_SECRET as string }),
